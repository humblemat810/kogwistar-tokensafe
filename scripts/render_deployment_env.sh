...
gateway_postgres_host="${MODELKEYGUARD_GATEWAY_POSTGRES_HOST:-${MODELKEYGUARD_POSTGRES_HOST}}"
gateway_postgres_port="${MODELKEYGUARD_GATEWAY_POSTGRES_PORT:-${MODELKEYGUARD_POSTGRES_PORT}}"
gateway_keycloak_url="${MODELKEYGUARD_GATEWAY_KEYCLOAK_URL:-${MODELKEYGUARD_KEYCLOAK_PUBLIC_URL}}"
...
gateway_postgres_dsn="postgresql://${MODELKEYGUARD_POSTGRES_USER}:${postgres_password_placeholder}@${gateway_postgres_host}:${gateway_postgres_port}/${MODELKEYGUARD_POSTGRES_DB}"
...
MODELKEYGUARD_POSTGRES_HOST=${gateway_postgres_host}
MODELKEYGUARD_POSTGRES_PORT=${gateway_postgres_port}
MODELKEYGUARD_POSTGRES_DB=${MODELKEYGUARD_POSTGRES_DB}
MODELKEYGUARD_POSTGRES_USER=${MODELKEYGUARD_POSTGRES_USER}
MODELKEYGUARD_POSTGRES_DSN=${gateway_postgres_dsn}
...
KEYCLOAK_URL=${gateway_keycloak_url}
...
MODELKEYGUARD_ADMIN_AUTH_MODE=${MODELKEYGUARD_ADMIN_AUTH_MODE:-keycloak}
